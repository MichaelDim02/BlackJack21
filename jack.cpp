...
//INTERFACE//
void interface() {
	cout << "BlackJack21 Password Cracker v0.1" << endl;
	cout << "Written by Michael Constantine Dimopoulos in C++ - Thessaloniki, Greece 2017" << endl;
	cout << "Python version: github.com/MichaelDim02/BlackJack" << endl;
	cout << "E-Mail: anivsante2@gmail.com" << endl;
	cout << "Hashes included: MD5, SHA1, SHA256, SHA512" << endl << endl;
	cout << "Usage: ./jack [HASH-TYPE] [HASH] [DICTIONARY]" << endl;
}
